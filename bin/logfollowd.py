...
define('debug', help='Whether to work in debug mode or not',
       default=True, type=bool)
define('host', help='Address to bing HTTP server',
       default='127.0.0.1', type=str)
define('port', help='HTTP port for listening incoming requests',
       default=8001, type=int)
define('gateway_host', help='Address to bind internal TCP server',
       default='127.0.0.1', type=str)
define('gateway_port', help='TPC port for handling log streams',
       default=6777, type=int)
